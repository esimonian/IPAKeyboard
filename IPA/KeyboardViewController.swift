...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.setupLayout()
        let orientationSavvyBounds = CGRect(x: 0, y: 0, width: self.view.bounds.width, height: self.heightForOrientation(UIDevice.current.orientation, withTopBanner: false))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.keyboardHeight = self.heightForOrientation(UIDevice.current.orientation, withTopBanner: true)
    }
    ...
    override func willRotate(to toInterfaceOrientation: UIInterfaceOrientation, duration: TimeInterval) {
        ...
        self.keyboardHeight = self.heightForOrientation(
            UIDevice.current.orientation, withTopBanner: true)
    }
    ...
    func heightForOrientation(_ orientation: UIDeviceOrientation, withTopBanner: Bool) -> CGFloat {
    ...
    func keyPressedHelper(_ sender: KeyboardKey) {
        if let model = self.layout?.keyForView(sender) {
            ...
            if model.type == Key.KeyType.space || model.type == Key.KeyType.returnKey {
                self.currentMode = 0
            }
